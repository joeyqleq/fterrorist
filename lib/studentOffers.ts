...
export const studentOffers: StudentOffer[] = [
  ...
  },
  {
    ...
    offer: "Gemini Advanced access, NotebookLM, creative tools, and workspace perks built for students",
    duration: "While enrolled",
    savings: "$240",
    eligibility: "University students",
    verification: ".edu email",
    notes: "Modern Gemini bundle replacing Google AI Studio: AI writing, coding, and creative tools bundled with storage.",
    link: "https://gemini.google/in/students",
  ...
  // Keeping existing offers that weren't marked for removal
  {
    ...
    link: "https://my.interserver.net/student_signup.php",
  ...
  },
  {
    ...
    duration: "While enrolled",
    savings: "$2,000",
    eligibility: "Students 13+ (approval can be manual/slow)",
    verification: "Academic email + proof; portfolio helps more than the email",
    notes:
      "Harder to get approved than it looks. If you want a near-guaranteed path, reach out via the contact modal and I'll walk you through the playbook.",
