...
export default function DonatePageClient(): JSX.Element {
  const copyToClipboard = (text: string): void => {
    navigator.clipboard.writeText(text).catch((_error: unknown) => {
        ...
        <div className="text-center mb-12 sm:mb-16" data-oid="g8:tt90">
          ...
          >
            <Target
              ...
              data-oid="cjsucj0"
            />
            You keep the anti-paywall arsenal alive: servers, nonstop scraping,
            and scholarships for people whose schools won't hand out .edu
            emails. The $13/.edu and $20/ID cover the labor; donations let us
            waive it when someone genuinely can't pay.{" "}
