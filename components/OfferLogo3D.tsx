...
export default function OfferLogo3D({ provider, imageUrl, size = "lg" }: OfferLogo3DProps) {
  ...
  return (
    ...
    >
      ...
      {/* Shadow and glow */}
      <div className={`absolute top-4 left-4 ${currentSize.container} bg-gradient-to-br ${fallbackColor} rounded-3xl opacity-30 -z-10 blur-xl`} />
      <div className={`absolute top-2 left-2 ${currentSize.container} bg-gradient-to-br ${fallbackColor} rounded-3xl opacity-20 -z-20 blur-2xl scale-110`} />
    </motion.div>
  )
}