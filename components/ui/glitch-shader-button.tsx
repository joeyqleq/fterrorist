...
export const GlitchShaderButton: React.FC<GlitchShaderButtonProps> = ({
  ...
  const drawShaderEffect = useCallback((ctx: CanvasRenderingContext2D, time: number) => {
  ...
  const variantStyles = {
    primary: 'border-green-400/40 bg-black/60 text-green-400 hover:bg-green-400/10',
    secondary: 'border-cyan-400/40 bg-black/60 text-cyan-400 hover:bg-cyan-400/10',
  ...
  return (
    ...
    >
      ...
      {/* Button Content */}
      <div className="relative z-[6] flex items-center justify-center px-6 py-3">
        {children}
      </div>
