          ...
          return (
            <button
              ...
              className={cn(
                ...
                isAll && "border-yellow-500/50 text-yellow-200 hover:border-yellow-400 hover:text-yellow-100",
                isAll && isSelected && "border-yellow-400 bg-yellow-500/20 text-yellow-300 shadow-lg shadow-yellow-500/25"
              )}
              style={{
