...
const cyberButtonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-black uppercase tracking-wider transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 overflow-hidden group",
  {
    variants: {
      variant: {
        primary: "bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white border border-cyan-500/50 shadow-lg hover:shadow-cyan-500/25 hover:from-cyan-400 hover:via-blue-500 hover:to-purple-500",
        secondary: "bg-gradient-to-r from-gray-800 to-gray-900 text-cyan-400 border border-gray-600 hover:border-cyan-500/50 hover:text-cyan-300",
        destructive: "bg-gradient-to-r from-red-600 via-pink-600 to-purple-600 text-white border border-red-500/50 shadow-lg hover:shadow-red-500/25",
        outline: "border-2 border-cyan-400/50 text-cyan-400 hover:bg-cyan-400/10 hover:border-cyan-400 backdrop-blur-sm",
        ghost: "text-cyan-400 hover:bg-cyan-400/10",
        hacker: "bg-black border border-green-400/50 text-green-400 font-mono hover:bg-green-400/10 hover:border-green-400 hover:text-green-300 shadow-lg hover:shadow-green-400/25",
      },
      size: {
      ...
      return React.cloneElement(child, {
        ...
        children: (
          <>
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 rounded-lg blur opacity-0 group-hover:opacity-30 transition duration-300"></div>
            
            {/* Animated border effect */}
            <div className="absolute inset-0 rounded-inherit">
              <div className="absolute inset-0 rounded-inherit border-2 border-transparent bg-gradient-to-r from-cyan-400/20 via-blue-500/20 to-purple-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-border-glow"></div>
            </div>
            ...
            {/* Scan line effect */}
            <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-scan transition-opacity duration-300"></div>
