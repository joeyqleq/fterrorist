  ...
  return (
    ...
    >
      {characters.map((char, index) => {
        ...
        return (
          <div key={index} style={charStyle} data-oid=".5q695s">
            {/* Font is now bigger and bolder */}
            <span
              className="text-base md:text-lg font-bold font-mono text-green-600 dark:text-green-400"
              data-oid="16yaoui"
            >
              {char}
            </span>
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          data-oid="m.zbmfg"
        >
          <TextArc text={text} diameter={diameter} data-oid="l3r-.7h" />
        </motion.div>
        ...
        >
          <div
            className="absolute w-[200%] h-[200%] top-[-50%] left-[-50%] animate-grain"
            data-oid="zuw23.:"
          ></div>
        </div>
      </div>
