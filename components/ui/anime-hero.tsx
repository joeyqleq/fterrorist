...
export default function AnimeHero({ className = "" }: AnimeHeroProps) {
  ...
  useEffect(() => {
    ...
    const makeGlow = () => {
      ...
      const DURATION = 1200;
      tlRef.current = animate(container, {
        scale: [0.98, 1.02],
        filter: [
  ...
  return (
    <div
      className={`relative mx-auto w-full max-w-2xl aspect-square ${className}`}
      data-oid="i_pi4m8"
    >
      {/* Canvas rings */}
      <canvas
      ...
      <div
        ...
        data-oid="vyjm2qt"
      >
        <div className="relative" data-oid="4s:l-px">
          <Logo
            size={220}
      ...
      <div
        ...
        data-oid="jk6kbze"
      >
        <div className="relative w-80 h-80" data-oid="e55:bc-">
          <Image
            ...
            style={{
              animation:
                "slowPulse 4s ease-in-out infinite, subtleGlitch 30s ease-in-out infinite",
            }}
            data-oid="tuljx0q"
          />
        </div>
